...
const routes = [
  ...
  { path: '/lms', component: () => import('../layouts/LmsLayout.vue'), meta: { auth: true, role: 'STUDENT' }, children: [
    ...
    { path: 'dashboard', component: () => import('../views/lms/LmsDashboardView.vue'), meta: { title: 'Tổng quan', hideBack: true } },
    { path: 'courses', component: () => import('../views/lms/CourseListView.vue'), meta: { title: 'Khóa học của tôi' } },
    { path: 'courses/:courseId', component: () => import('../views/lms/CourseDetailView.vue'), meta: { title: 'Chi tiết khóa học', backTo: '/lms/courses' } },
    { path: 'courses/:courseId/lessons/:lessonId', component: () => import('../views/lms/LessonPlayerView.vue'), meta: { title: 'Bài học', backTo: route => `/lms/courses/${route.params.courseId}` } },
  ...
  { path: '/cms', component: () => import('../layouts/CmsLayout.vue'), meta: { auth: true, cms: true }, children: [
    ...
    { path: 'dashboard', component: () => import('../views/cms/CmsDashboardView.vue'), meta: { title: 'Tổng quan', hideBack: true } },
    { path: 'search', component: () => import('../views/cms/GlobalSearchView.vue'), meta: { title: 'Tìm kiếm' } },
    { path: 'academic', component: () => import('../views/cms/AcademicStructureView.vue'), meta: { title: 'Cơ cấu đào tạo' } },
    { path: 'courses', component: () => import('../views/cms/CourseManagementView.vue'), meta: { title: 'Khóa học' } },
    { path: 'courses/:id/content', component: () => import('../views/cms/ContentBuilderView.vue'), meta: { title: 'Nội dung khóa học', backTo: '/cms/courses' } },
    { path: 'videos', component: () => import('../views/cms/VideoLibraryView.vue'), meta: { title: 'Thư viện video' } },
    { path: 'videos/:id/editor', component: () => import('../views/cms/VideoEditorView.vue'), meta: { title: 'Biên tập video', backTo: '/cms/videos' } },
