...
<style scoped>
.interactive-player{height:100%;min-height:0;display:grid;grid-template-rows:minmax(0,1fr) 92px;overflow:hidden;background:#fff}.interactive-stage{height:auto;min-height:0;overflow:hidden;background:#071922;position:relative;display:grid;place-items:center}.interactive-stage video{display:block;width:100%;height:100%;min-height:0;object-fit:contain;background:#000}.interactive-empty{display:grid;place-items:center;gap:.6rem;color:#d5e1dc}.interactive-empty i{font-size:3rem;color:#ffff1a}.interactive-empty span{color:#93a8a0;font-size:.82rem}.interaction-timeline{min-width:0;padding:.7rem 1.15rem .4rem;background:#fff;border-top:1px solid #edf1ef}.interaction-track{height:12px;margin:.4rem .25rem 2.25rem;border-radius:6px;background:#e3ebe8;position:relative;outline:none}.interaction-track.seekable{cursor:pointer}.interaction-track:focus-visible{box-shadow:0 0 0 4px rgba(0,80,153,.14)}.interaction-track-progress{position:absolute;inset:0 auto 0 0;border-radius:6px;background:#c9dcd5;pointer-events:none}.interaction-playhead{position:absolute;top:50%;z-index:3;width:4px;height:28px;border-radius:4px;background:#005099;transform:translate(-50%,-50%);box-shadow:0 2px 7px rgba(0,80,153,.28);pointer-events:none}.timeline-question{position:absolute;top:50%;z-index:4;transform:translate(-50%,-50%);border:0;background:transparent;color:#cd1b1b;padding:0;font-size:1.18rem;line-height:1}.timeline-question.answered{color:#07875a}.timeline-question>span{position:absolute;top:19px;left:50%;transform:translateX(-50%);color:#52645e;font-size:.65rem;white-space:nowrap}.timeline-question.staggered>span{top:30px}.timeline-current{display:flex;justify-content:flex-end;align-items:center;gap:.4rem;color:#63736d;font-size:.78rem}.timeline-current i{color:#07875a}.timeline-current strong{color:#005099;font-size:.88rem}.interaction-backdrop{position:fixed;inset:0;background:rgba(10,31,24,.66);z-index:2000;display:grid;place-items:center;padding:1rem}.interaction-modal{width:min(590px,100%);padding:2rem;position:relative;max-height:92vh;overflow:auto}.interaction-modal h2{font-size:1.4rem;font-weight:750;margin-top:1rem}.interaction-close{position:absolute;right:1rem;top:1rem;border:0;background:#f3f6f5;width:34px;height:34px;border-radius:8px}.interaction-answer{display:flex;align-items:center;gap:.75rem;padding:.8rem;margin:.55rem 0;background:#f7f9f8;border-radius:9px}.interaction-answer>span{width:28px;height:28px;border-radius:7px;background:white;display:grid;place-items:center;font-weight:750}.interaction-result{text-align:center;padding-top:1rem}.interaction-result>i{font-size:3.5rem}.interaction-result.correct{color:#07875a}.interaction-result.wrong{color:#cd1b1b}.interaction-result.pending{color:#8a7000}.interaction-result h3{font-size:1.3rem;margin:.6rem 0}.interaction-result p{color:#53655f;margin-top:1rem}@media(max-width:600px){.interactive-player{grid-template-rows:minmax(0,1fr) 86px}.interaction-timeline{padding-left:.75rem;padding-right:.75rem}.timeline-current{font-size:.72rem}}
</style>
