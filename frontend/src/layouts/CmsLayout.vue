...
.top-search{width:270px;height:42px;background:var(--eduvers-primary);color:#7b8581}.top-search input{color:#34433e;font-size:.79rem}.icon-button{width:40px;height:40px;background:var(--eduvers-primary);color:#0d2944}.user-summary{min-height:46px;padding:.25rem .65rem .25rem .35rem;border-radius:9px;background:var(--eduvers-primary)}.user-avatar{border:0;box-shadow:none}.tiny{color:#7b8581}.logout-button,.menu-toggle{width:40px;height:40px;background:var(--eduvers-primary)}
