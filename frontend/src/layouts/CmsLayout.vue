...
.side-link:hover{color:#0d2944;background:#f8f4f2}.side-link.router-link-active{color:#07875a;background:#e9f5f0;box-shadow:none}
.side-link i{width:30px;height:30px;display:grid;place-items:center;border-radius:7px;background:#f5f3f1;color:#60706b;font-size:.96rem}.side-link.router-link-active i{background:#fff;color:#07875a}
.support-card{padding:1rem;background:#0d2944;border-radius:10px}.support-card>i{width:34px;height:34px;display:grid;place-items:center;border-radius:7px;background:rgba(255,255,255,.1);color:#ffff1a;font-size:1rem}.support-card strong{font-size:.78rem}.support-card span{color:rgba(255,255,255,.66);font-size:.66rem}
.topbar{height:78px;border-bottom:1px solid #ede8e6;box-shadow:none}.topbar-heading small{display:block;color:#07875a;font-size:.58rem;font-weight:750;letter-spacing:.11em}.topbar-heading div>div{color:#0d2944;font-size:.95rem;font-weight:700}
...
.page-content{max-width:1840px;padding:1.75rem!important}.mobile-sidebar{width:288px;background:#fff;color:#0d2944}.mobile-sidebar .offcanvas-header{height:78px;border-bottom:1px solid #ede8e6}.mobile-sidebar .brand{border:0}
