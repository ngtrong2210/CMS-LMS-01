<template>
  <div class="cms-shell cms-theme">
    <aside class="sidebar d-none d-lg-flex flex-column">
      <RouterLink class="brand px-4" to="/cms/dashboard"><img class="brand-mark" src="/images/learnhub-mark.svg" alt=""><span>LearnHub <small>CMS</small></span></RouterLink>
