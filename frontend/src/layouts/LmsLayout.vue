...
.lms-nav{min-height:72px;border-bottom:1px solid var(--eduvers-bdr-color);box-shadow:none}.brand{color:var(--eduvers-black);font-size:1rem}.brand:hover{color:var(--eduvers-black)}.brand>span{display:grid;line-height:1.05}.brand strong{font-size:1.08rem}.brand small{margin-top:.28rem;color:var(--eduvers-base);font-size:.58rem;font-weight:750;letter-spacing:.07em}.brand-mark{width:42px;height:42px;border-radius:var(--eduvers-bdr-radius);box-shadow:0 5px 16px rgba(13,41,68,.1)}
