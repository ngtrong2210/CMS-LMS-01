  ...
  <div class="lms-shell">
    ...
    <nav class="navbar navbar-expand-lg bg-white sticky-top lms-nav">
      <div class="container py-2">
        <RouterLink class="brand" to="/lms/dashboard"><img class="brand-mark" src="/images/learnhub-mark.svg" alt=""><span><strong>LearnHub</strong><small>Không gian học tập</small></span></RouterLink>
...
.lms-shell{min-height:100vh;display:flex;flex-direction:column;background:#f7f7f5}.learning-strip{height:34px;display:flex;align-items:center;background:#0d2944;color:rgba(255,255,255,.78);font-size:.68rem}.learning-strip .container{display:flex;justify-content:space-between;align-items:center}.learning-strip i{margin-right:.35rem;color:#ffff1a}
.lms-nav{min-height:72px;border-bottom:1px solid #ede8e6;box-shadow:none}.brand{color:#0d2944;font-size:1rem}.brand:hover{color:#0d2944}.brand>span{display:grid;line-height:1.05}.brand strong{font-size:1.08rem}.brand small{margin-top:.28rem;color:#07875a;font-size:.58rem;font-weight:750;letter-spacing:.07em}.brand-mark{width:42px;height:42px;border-radius:9px;box-shadow:0 5px 16px rgba(13,41,68,.1)}
.nav-link{position:relative;padding:.65rem 1rem!important;color:#56635f;border-radius:7px;font-size:.82rem;font-weight:700}.nav-link:hover{color:#07875a;background:#f8f4f2}.nav-link.router-link-active{color:#07875a;background:#e9f5f0}.profile-link{min-height:46px;padding:.28rem .65rem .28rem .3rem;background:#f8f4f2;border-radius:9px}.profile-link:hover{background:#eee9e6}.user-avatar{border:0;box-shadow:none}.profile-copy{line-height:1.15}.profile-copy strong{color:#0d2944;font-size:.75rem}.profile-copy small{margin-top:.2rem;color:#7b8581;font-size:.62rem}
.lms-content{width:100%;max-width:1360px;flex:1}.lms-footer{padding:1.15rem 0;border-top:1px solid #ede8e6;background:#fff;color:#7b8581;font-size:.7rem}.lms-footer .container{display:flex;justify-content:space-between;gap:1rem}
