...
(N'dbo',N'VideoAssetShares',N'Danh sách giáo viên được tác giả chia sẻ trực tiếp từng tài nguyên video.'),
...
(N'dbo',N'VideoAssets',N'ShareScope',N'Phạm vi chia sẻ: riêng tư, một số giáo viên được chọn hoặc toàn trường.'),
...
-- VideoAssetShares
(N'dbo',N'VideoAssetShares',N'Id',N'Khóa chính tự tăng của lượt chia sẻ video.'),
(N'dbo',N'VideoAssetShares',N'VideoAssetId',N'ID tài nguyên video được chia sẻ.'),
(N'dbo',N'VideoAssetShares',N'TeacherId',N'ID giáo viên được quyền nhìn thấy và sử dụng video.'),
(N'dbo',N'VideoAssetShares',N'SharedBy',N'ID tác giả hoặc quản trị viên thực hiện chia sẻ.'),
(N'dbo',N'VideoAssetShares',N'SharedAt',N'Thời điểm cấp quyền chia sẻ theo UTC.'),
-- Questions
