...
using SimsData.Data;
using SimsData.Health;
using SimsData.Security;
using SimsService.Services;
using SimsData.Storage;
...
{
    public static IServiceCollection AddSimsServices(this IServiceCollection services)
    {
